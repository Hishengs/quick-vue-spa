...
module.exports= class Creator {
  ...
  start (){
    ...
    this.packageJson.name = this.opt.projectName;
    this.query().then(() => {
      // set project path
      this.projectPath = path.join(this.baseDir, this.opt.projectName);
      ...
      ['dist', 'build', 'page', 'component', 'store', 'plugin', 'style', 'util', 'api'].forEach(name => {
      ...
      this.printLog('done.');
      console.log(`\nTo get started, cd "${this.opt.projectName}", run "npm install", then run "npm run dev".`);
